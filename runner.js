  ...
  (function (a) {
    function b(n, p, q, u) {
      if (
        ...
        require("fs").readFile(n, function (r, B) {
          r ? u(r) : q(B.buffer);
        });
      else {
        ...
        v.onprogress = function (r) {
          ...
          if (r.loaded) {
            v.Fi
              ? (k.vj[n].loaded = r.loaded)
              : ((v.Fi = !0),
                k.vj || (k.vj = {}),
                (k.vj[n] = { loaded: r.loaded, total: B }));
            var y = (B = r = 0),
              G;
            for (G in k.vj) {
              var K = k.vj[G];
    ...
    function d() {
      ...
      function p(v) {
        ...
        for (var r = 0; r < v.length; ++r)
          n.prototype.Fi[v[r].filename].onload();
      ...
      n.prototype = {
        ...
        send: function () {},
        onload: function () {
          this.finish(this.Li.subarray(this.start, this.end));
        },
        finish: function (v) {
    ...
    files: [
      { filename: "/assets/credits.txt", start: 0, end: 11278, audio: 0 },
      {
...
this.activate_clipboard = function () {
  !xa &&
    ...
    ((ya = !0),
    navigator.permissions
      .query({ name: "clipboard-read", Pl: !0 })
      .then(function (a) {
...
this.__gx_cache_file = function (a) {
  if (window.oprt && window.oprt.gameFiles) {
    ...
    null != d &&
      null != e &&
      null != c &&
      (b = window.location.origin + "/" + d + "/" + e + "/" + c + "/" + a.name);
    ...
    window.oprt.gameFiles.fetchAndCache(f, Ba, b).then((g) => {
      g.arrayBuffer().then(function () {
        ...
        Aa[a.name] = { name: a.name, md5: a.md5, fileId: f, version: Ba };
      });
    });
  }
      ...
      window.oprt.gameFiles
        ...
        .then((f) => {
          ...
          for (var n = 0; n < f.length; ++n) {
            ...
            0 > v || d[v] != u
              ? h.push(window.oprt.gameFiles.delete(p.fileId, p.version))
              : (g[q] = {
                  name: q,
                  md5: u,
                  fileId: p.fileId,
          ...
          void 0 == Aa["game.unx"]
            ? (console.log("caching game.unx"),
              this.__gx_cache_file(za["game.unx"]).then(() => {
                b({ cachedFiles: Aa, allFiles: e });
              }))
            : b({ cachedFiles: Aa, allFiles: e });
        })
        .catch((f) => {
          c(
            Error("error trying to enumerate cache keys - " + JSON.stringify(f))
          );
        });
...
GXMFS = {
  ...
  ck: (a, b) => {
    ...
    for (a = Da(a.jj).filter(c).map(d(a.jj)); a.length; ) {
      ...
      C(g.mode) && a.push.apply(a, Da(f).filter(c).map(d(f)));
  ...
  dk: (a, b) => {
    GXMFS.ml(a.jj, (c, d) => {
      ...
      d.list()
        .then((e) => {
          b(null, { type: "remote", storage: d, entries: e });
        })
        .catch(b);
    });
  },
  fk: (a, b) => {
    ...
    return C(d.mode)
      ...
      : 32768 === (d.mode & 61440)
      ? ((c.Hi = Ga(c)),
        b(null, { timestamp: d.mtime, mode: d.mode, contents: c.Hi }))
  ...
  lk: (a, b, c) => {
    function d(p) {
      ...
      if (0 === e && !h)
        return console.info("Reconcile finished successfully"), c(null);
    }
    ...
    console.debug(
      `${f.length} entries to create/update on the ${
        "local" === b.type ? "local filesystem" : "remote filesystem"
      }`
    );
    var g = [];
    ...
    console.debug(
      `${g.length} entries to remove from the ${
        "local" === b.type ? "local filesystem" : "remote filesystem"
      }`
    );
...
if (Ta) {
  ...
  !k.thisProgram &&
    ...
    (Pa = process.argv[1].replace(/\\/g, "/"));
  Oa = process.argv.slice(2);
  "undefined" != typeof module && (module.exports = k);
  process.on("uncaughtException", (a) => {
    if (!("unwind" === a || a instanceof $a || a.context instanceof $a))
      throw a;
  });
  Qa = (a, b) => {
    process.exitCode = a;
  ...
  Sa
    ? (Ua = self.location.href)
    : "undefined" != typeof document &&
      document.currentScript &&
      (Ua = document.currentScript.src),
    (Ua =
      0 !== Ua.indexOf("blob:")
        ? Ua.substr(0, Ua.replace(/[?#].*/, "").lastIndexOf("/") + 1)
        : ""),
    (Va = (a) => {
...
var I,
  ...
  Mb = {
    ...
    1525669: (a) => {
      "function" == typeof showRollbackMessage &&
        showRollbackMessage(a ? x(w, a) : "");
    },
    1525762: () => {
      var a = document.getElementById("stats-button");
    ...
    1526124: (a, b) => {
      gxc_set_player_status(a, b ? x(w, b) : "");
    },
    1526175: (a) => {
    ...
    1526628: (a) => {
      "function" == typeof wallpaper_init_config_controls &&
        wallpaper_init_config_controls(JSON.parse(a ? x(w, a) : ""));
    },
    1526755: (a) => {
      "function" == typeof wallpaper_init_subscriptions &&
        wallpaper_init_subscriptions(JSON.parse(a ? x(w, a) : ""));
    },
    1526878: (a) => {
      alert(a ? x(w, a) : "");
    },
    ...
    1527204: () => {
      ...
      window.matchMedia("(orientation:portrait)").matches
        ? (a = 1)
        : window.matchMedia("(orientation:landscape)").matches && (a = 0);
      return a;
    },
    1527382: (a) => {
    ...
    1528607: (a) => {
      ...
      d.muted = !1;
      d.src = a;
      const e = { Jl: k.cwrap("video_playback_ended", "", "") },
        f = { Kl: k.cwrap("video_playback_started", "", "") };
      ...
      const g = () => {
        ...
        null == h.Vi
          ? ((h.Vi = document.createElement("canvas")),
            (h.Vi.style.cssText =
              "position:fixed; top:1px; left:1px; width:1px; height:1px"),
            (h.Vi.width = d.videoWidth),
            (h.Vi.height = d.videoHeight),
            document.body.appendChild(h.Vi),
            (h.Hj = h.Vi.getContext("2d", {
              alpha: !1,
              Ql: !1,
          ...
          : (d.videoWidth != h.Vi.width && (h.Vi.width = d.videoWidth),
            h.Vi.height != d.videoHeight && (h.Vi.height = d.videoHeight));
        null != h.Fi && null != h.Hj && h.Hj.drawImage(h.Fi, 0, 0);
        null != h.Fi &&
          (null != h.Fi.src
            ? h.Fi.requestVideoFrameCallback(g)
    ...
    1532618: () => {
      ...
      return null != a.Fi
        ? a.Fi.ended
          ...
          : a.Fi.paused
          ? 3
          : a.Fi.readyState < a.Fi.HAVE_CURRENT_DATA
          ? 1
          : 2
        : 0;
    },
    ...
    1533430: (a, b, c, d) => {
      ...
      if (MediaRecorder.isTypeSupported("video/webm;codecs=vp9")) {
        ...
        MediaRecorder.isTypeSupported("video/webm;codecs=vp8")
          ? ((f = { mimeType: "video/webm; codecs=vp8" }),
      ...
      null == e.bj &&
        ((e.bj = document.createElement("canvas")),
        (e.bj.style.cssText =
          "position:fixed; top:1px; left:1px; width:1px; height:1px"),
        (e.bj.width = a),
        (e.bj.height = b),
        document.body.appendChild(e.bj),
        console.log("Game Canvas width:" + e.width + " height:" + e.height),
        (e.Vk = e.bj.getContext("2d", {
          alpha: !1,
          desynchronized: !0,
          antialias: !0,
          powerPreference: "low-power",
        ...
        (e.mj = document.createElement("video")),
        (e.mj.autoplay = !0),
        (e.mj.Nl = !0),
        (e.mj.muted = !0),
        (e.mj.style.cssText =
          "position:fixed;top:1px;left:1px;width:1px;height:1px"),
        document.body.appendChild(e.mj),
        (e.mj.srcObject = e.yk),
        (a = e.bj.captureStream(c)),
        0 < d &&
          ((d = da
    ...
    1535926: (a) => {
      ...
      if (b.Li && ("recording" == b.Li.state || "paused" == b.Li.state)) {
        ...
        b.Li.onstop = function () {
          ...
          b.Wj = null;
          const e = {
            jk: k.cwrap("post_video_upload_callback", "", ["string"]),
          };
          if (c.startsWith("http"))
            fetch(c, { method: "PUT", body: d })
              .then(() => {
    ...
    1537910: () => {
      ...
      "number" == typeof window.innerHeight
        ? (a = window.innerHeight * window.devicePixelRatio)
    ...
    1538404: (a, b, c, d) => {
      ...
      if (void 0 != window.oprt) {
        ...
        0 != (a & 5) && void 0 != h && "function" == typeof h
          ? (h(), console.log("Locking to Landscape"), (e = 0))
          : 0 != (a & 10) &&
            void 0 != g &&
            "function" == typeof g &&
            (g(), console.log("Locking to Portrait"), (e = 0));
      }
      return e;
    },
    1539392: (a) => {
      a
        ? void 0 != window.oprt && void 0 != window.oprt.enterFullscreen
          ? (console.log("enterFullscreen"), window.oprt.enterFullscreen())
          : (console.log("canvas requesting enterFullscreen"),
            document.querySelector("canvas").requestFullscreen())
        : void 0 != window.oprt && void 0 != window.oprt.exitFullscreen
        ? (console.log("exitFullscreen"), window.oprt.exitFullscreen())
    ...
    1540079: (a) => {
      document.querySelector("canvas").style.cursor = a ? x(w, a) : "";
    },
    ...
    1541431: (a, b) => {
      this.chrome &&
        this.chrome.runtime &&
        chrome.runtime.sendMessage(a ? x(w, a) : "", {
          command: b ? x(w, b) : "",
        });
    },
    1541568: (a, b, c, d, e) => {
      ...
      const g = { Wk: k.cwrap("YYSum", "", ["number", "number"]) };
      this.chrome &&
        this.chrome.runtime &&
        ((e = w.subarray(e, e + 20)),
        (a = a ? x(w, a) : ""),
        chrome.runtime.sendMessage(
          c ? x(w, c) : "",
          { command: d ? x(w, d) : "", randomString: a, hash: e },
          f
        ));
    },
    1542128: () =>
      window.matchMedia("(any-hover: none)").matches ||
      window.matchMedia("(any-hover: hover) and (pointer: coarse)").matches ||
      "undefined" != typeof window.oprt,
    ...
    1543015: () => {
      Gb("/_savedata");
      window.oprt && window.oprt.gameStorage
        ? Hb(GXMFS, "/_savedata")
        : Hb(L, "/_savedata");
      Eb(!0, function () {
    ...
    1544602: () => (null == da ? 0 : da.currentTime),
          ...
          .then((b) => {
            ...
            ja.audioWorklet
              ...
              .then(() => {
                ...
                const d = c(b);
                1 < d
                  ? ((la = new ChannelMergerNode(ja, { numberOfInputs: d })),
                    ha.connect(la),
                    la.connect(ka))
                  : ha.connect(ka);
                ja.resume();
    ...
    1548785: (a) => {
      ...
      b.Mi ||
        ("undefined" !== typeof AudioContext
          ? (b.Mi = new AudioContext())
          : "undefined" !== typeof webkitAudioContext &&
            (b.Mi = new webkitAudioContext()),
        b.Mi && Kb(b.Mi));
    ...
    1549346: (a, b, c, d) => {
      ...
      function f(h) {
        void 0 !== g.capture.Ej &&
          (clearTimeout(g.capture.Ej), (g.capture.Ej = void 0));
        ...
        g.capture.Pi.onaudioprocess = function (n) {
          void 0 !== g &&
            void 0 !== g.capture &&
            (n.outputBuffer.getChannelData(0).fill(0),
            (g.capture.Zj = n.inputBuffer),
            Lb("vi", c, [d]));
        };
    ...
    1550998: (a, b, c, d) => {
      ...
      e.audio.Pi.onaudioprocess = function (f) {
        void 0 !== e &&
          void 0 !== e.audio &&
          ((e.audio.Fk = f.outputBuffer), Lb("vi", c, [d]));
      };
      e.audio.Pi.connect(e.Mi.destination);
    },
    1551408: (a, b) => {
      for (
        var c = k.SDL2, d = c.capture.Zj.numberOfChannels, e = 0;
        e < d;
        ++e
      ) {
        ...
        if (1 == d) for (var g = 0; g < b; ++g) Jb(a + 4 * g, f[g], "float");
        else for (g = 0; g < b; ++g) Jb(a + 4 * (g * d + e), f[g], "float");
      }
    },
    1552013: (a, b) => {
    ...
    1552493: (a) => {
      ...
      if (a) {
        ...
        void 0 !== b.capture.Pi &&
          ((b.capture.Pi.onaudioprocess = function () {}),
          b.capture.Pi.disconnect(),
          (b.capture.Pi = void 0));
        void 0 !== b.capture.Oj &&
          (b.capture.Oj.disconnect(), (b.capture.Oj = void 0));
        void 0 !== b.capture.Rj && (b.capture.Rj = void 0);
        b.capture = void 0;
      } else
        void 0 != b.audio.Pi &&
          (b.audio.Pi.disconnect(), (b.audio.Pi = void 0)),
          (b.audio = void 0);
      void 0 !== b.Mi &&
        void 0 === b.audio &&
        void 0 === b.capture &&
        (b.Mi.close(), (b.Mi = void 0));
    },
    1553665: (a, b, c) => {
      k.SDL2 || (k.SDL2 = {});
      var d = k.SDL2;
      d.$k !== k.canvas &&
        ((d.Xi = k.createContext(k.canvas, !1, !0)), (d.$k = k.canvas));
      if (d.w !== a || d.h !== b || d.ol !== d.Xi)
        (d.image = d.Xi.createImageData(a, b)),
          (d.w = a),
          (d.h = b),
          (d.ol = d.Xi);
      a = d.image.data;
      ...
      if (
        ...
        (d.cl !== a &&
          ((d.bl = new Int32Array(a.buffer)),
          (d.dl = new Uint8Array(a.buffer)),
          (d.cl = a)),
        (a = d.bl),
        (c = a.length),
        a.set(E.subarray(b, b + c)),
        (a = d.dl),
        (b = 3),
        (e = b + 4 * c),
        0 == c % 8)
...
var Nb = (a, b, c) => {
  ...
  Lb = (a, b, c) => {
    a.includes("j")
      ? ((a = k["dynCall_" + a]),
        (b = c && c.length ? a.apply(null, [b].concat(c)) : a.call(null, b)))
      : (b = M(b).apply(null, c));
    return b;
  };
function Ib(a, b = "i8") {
...
var $b = (a, b) => {
  ...
  x = (a, b, c) => {
    var d = b + c;
    for (c = b; a[c] && !(c >= d); ) ++c;
    if (16 < c - b && a.buffer && ac) return ac.decode(a.subarray(b, c));
    for (d = ""; b < c; ) {
      var e = a[b++];
      if (e & 128) {
        var f = a[b++] & 63;
...
var gc = {
    ...
    write(a, b, c, d) {
      ...
      try {
        for (var e = 0; e < d; e++) a.tty.dj.kk(a.tty, b[c + e]);
      } catch (f) {
        throw new O(29);
      }
...
function jc(a, b) {
  ...
  c >= b ||
    ...
    0 < a.Ji && a.Hi.set(c.subarray(0, a.Ji), 0));
}
var z = {
    $i: null,
    Ni() {
    ...
    createNode(a, b, c, d) {
      ...
      z.$i ||
        (z.$i = {
          ...
          link: {
            node: { Zi: z.Gi.Zi, Qi: z.Gi.Qi, readlink: z.Gi.readlink },
            stream: {},
          },
          Ek: { node: { Zi: z.Gi.Zi, Qi: z.Gi.Qi }, stream: kc },
        });
      c = lc(a, b, c, d);
      C(c.mode)
        ? ((c.Gi = z.$i.dir.node), (c.Ii = z.$i.dir.stream), (c.Hi = {}))
        : 32768 === (c.mode & 61440)
        ? ((c.Gi = z.$i.file.node),
          (c.Ii = z.$i.file.stream),
          (c.Ji = 0),
          (c.Hi = null))
        : 40960 === (c.mode & 61440)
        ? ((c.Gi = z.$i.link.node), (c.Ii = z.$i.link.stream))
        : 8192 === (c.mode & 61440) &&
          ((c.Gi = z.$i.Ek.node), (c.Ii = z.$i.Ek.stream));
    ...
    Gi: {
      ...
      Qi(a, b) {
        ...
        if (void 0 !== b.size && ((b = b.size), a.Ji != b))
          if (0 == b) (a.Hi = null), (a.Ji = 0);
            ...
            var c = a.Hi;
            a.Hi = new Uint8Array(b);
            c && a.Hi.set(c.subarray(0, Math.min(b, a.Ji)));
            a.Ji = b;
          }
      },
      lookup() {
      ...
      rename(a, b, c) {
        if (C(a.mode)) {
          ...
          if (d) for (var e in d.Hi) throw new O(55);
        }
      ...
      readdir(a) {
        var b = [".", ".."],
          c;
        for (c in a.Hi) a.Hi.hasOwnProperty(c) && b.push(c);
        return b;
      },
      symlink(a, b, c) {
    ...
    Ii: {
      ...
      write(a, b, c, d, e, f) {
        ...
        if (b.subarray && (!a.Hi || a.Hi.subarray)) {
          if (f) return (a.Hi = b.subarray(c, c + d)), (a.Ji = d);
          if (0 === a.Ji && 0 === e)
            return (a.Hi = b.slice(c, c + d)), (a.Ji = d);
          if (e + d <= a.Ji) return a.Hi.set(b.subarray(c, c + d), e), d;
        }
        jc(a, e + d);
        if (a.Hi.subarray && b.subarray) a.Hi.set(b.subarray(c, c + d), e);
        else for (f = 0; f < d; f++) a.Hi[e + f] = b[c + f];
      ...
      qj(a, b, c) {
        1 === c
          ? (b += a.position)
          : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.Ji);
  ...
  L = {
    ...
    ll: (a, b) => {
      ...
      d.onupgradeneeded = (e) => {
        ...
        var g;
        f.objectStoreNames.contains(L.lj)
          ? (g = e.objectStore(L.lj))
          : (g = f.createObjectStore(L.lj));
        g.indexNames.contains("timestamp") ||
    ...
    dk: (a, b) => {
      ...
      L.ll(a.jj, (d, e) => {
        ...
        try {
          ...
          f.objectStore(L.lj).index("timestamp").openKeyCursor().onsuccess = (
            g
          ) => {
            g = g.target.result;
            if (!g) return b(null, { type: "remote", db: e, entries: c });
    ...
    lk: (a, b, c) => {
      ...
      Object.keys(a.entries).forEach(function (q) {
        var u = a.entries[q],
          v = b.entries[q];
        (v && u.timestamp.getTime() == v.timestamp.getTime()) ||
          (f.push(q), e++);
      });
      var g = [];
      ...
      if (!e) return c(null);
      var h = !1,
        n = ("remote" === a.type ? a.db : b.db).transaction(
          [L.lj],
          "readwrite"
        ),
...
function Ec(a) {
  for (var b; ; ) {
    if (a === a.parent)
      return (a = a.Ni.jj), b ? ("/" !== a[a.length - 1] ? `/` : a + b) : a;
    b = b ? `${a.name}/` : a.name;
    a = a.parent;
  }
}
...
function Nc() {
  for (var a = 0; 4096 >= a; a++) if (!yc[a]) return a;
  throw new O(33);
}
function Oc(a) {
  a = yc[a];
...
function Ja(a, b) {
  a = "string" == typeof a ? Fa(a, { oj: !0 }).node : a;
  if (!a.Gi.Qi) throw new O(63);
  a.Gi.Qi(a, { mode: (b & 4095) | (a.mode & -4096), timestamp: Date.now() });
}
function Ka(a, b, c) {
  a = Fa(a, { oj: !0 }).node;
  a.Gi.Qi(a, { timestamp: Math.max(b, c) });
}
function Xc(a, b, c) {
  if ("" === a) throw new O(44);
  if ("string" == typeof b) {
...
function hd(a, b, c, d, e) {
  ...
  f.prototype.Bk = function () {
    ...
    var u = Number(q.getResponseHeader("Content-length")),
      v,
      r = (v = q.getResponseHeader("Accept-Ranges")) && "bytes" === v;
    ...
    y.Fi((G) => {
      ...
      if ("undefined" == typeof y.ej[G]) {
        ...
        if (K > N)
          throw Error(
            "invalid range (" + K + ", " + N + ") or no bytes requested!"
          );
        if (N > u - 1)
  ...
  p.read = (q, u, v, r, B) => {
    ...
    if (B >= q.length) u = 0;
      ...
      r = Math.min(q.length - B, r);
      if (q.slice) for (var y = 0; y < r; y++) u[v + y] = q[B + y];
      else for (y = 0; y < r; y++) u[v + y] = q.get(B + y);
      u = r;
    }
    return u;
  };
      ...
      if ((wd || (wd = !0), 0 == a))
        ...
        if ("undefined" == typeof setImmediate) {
          ...
          setImmediate = function (d) {
            c.push(d);
            Sa
              ? (void 0 === k.setImmediates && (k.setImmediates = []),
                k.setImmediates.push(d),
      ...
      if (!eb)
        if (0 < Ed.length) {
          ...
          if (Fd) {
            ...
            Fd = c.Yl ? e : (8 * d + (e + 0.5)) / 9;
          }
          k.setStatus &&
            ((c = k.statusMessage || "Please wait..."),
            (d = Fd),
            (e = Gd.$l),
            d
              ? d < e
          ...
          if (((Hd = (Hd + 1) | 0), 1 == td && 1 < ud && 0 != Hd % ud)) xd();
            ...
            if (R)
              for (
                ...
                R.kj[c] = 0;
            eb ||
              (k.preMainLoop && !1 === k.preMainLoop()) ||
              (Id(a), k.postMainLoop && k.postMainLoop());
            b < Dd ||
              ("object" == typeof SDL &&
                SDL.audio &&
                SDL.audio.yl &&
  ...
  if (!Rd) {
    ...
    pc.push({
      ...
      handle: function (c, d, e, f) {
        var g = new Blob([c], { type: Sd(d) });
        g.size !== c.length &&
          (g = new Blob([new Uint8Array(c).buffer], { type: Sd(d) }));
    ...
    pc.push({
      canHandle: function (c) {
        return !k.em && c.substr(-4) in { ".ogg": 1, ".wav": 1, ".mp3": 1 };
      },
      handle: function (c, d, e) {
        ...
        var g = !1,
          h = URL.createObjectURL(new Blob([c], { type: Sd(d) })),
          n = new Audio();
        n.addEventListener("canplaythrough", () => f(n), !1);
        n.onerror = function () {
          if (!g) {
            l(
              `warning: browser could not fully decode audio , trying slower base64 approach`
            );
        ...
        b.addEventListener(
          ...
          (c) => {
            !Pd &&
              ...
              (k.canvas.requestPointerLock(), c.preventDefault());
          },
          !1
        ));
  }
...
function ae(a, b) {
  function c() {
    ...
    (document.fullscreenElement ||
      ...
      ? ((d.exitFullscreen = be),
        Zd && d.requestPointerLock(),
        (Od = !0),
        $d
          ? ("undefined" != typeof SDL &&
              (E[SDL.screen >> 2] = F[SDL.screen >> 2] | 8388608),
            ce(k.canvas),
            de())
          : ce(d))
      : (f.parentNode.insertBefore(d, f),
        ...
        $d
          ? ("undefined" != typeof SDL &&
              (E[SDL.screen >> 2] = F[SDL.screen >> 2] & -8388609),
            ce(k.canvas),
            de())
          : ce(d));
...
function ce(a, b, c) {
  ...
  var d = b,
    e = c;
  k.forcedAspectRatio &&
    0 < k.forcedAspectRatio &&
    (d / e < k.forcedAspectRatio
      ? (d = Math.round(e * k.forcedAspectRatio))
      : (e = Math.round(d / k.forcedAspectRatio)));
  if (
    (document.fullscreenElement ||
      document.mozFullScreenElement ||
      document.msFullscreenElement ||
...
var qc = {},
  ...
  ie = 0,
  je = 0,
  ke = { alpha: !1, depth: !1, stencil: !1, antialias: !1 },
  le = {},
  me,
  ne = (a) => {
    ...
    b &&
      ...
      (a.drawArraysInstanced = (c, d, e, f) =>
        b.drawArraysInstancedANGLE(c, d, e, f)),
      (a.drawElementsInstanced = (c, d, e, f, g) =>
...
function Ke(a) {
  ...
  for (var b = 0; b < R.Mk; ++b) {
    ...
    if (c.Bj && c.enabled) {
      ...
      h
        ? (e = h)
        : ((h = S.getParameter(34964)),
          (f[g] = S.createBuffer()),
          S.bindBuffer(34962, f[g]),
          S.bufferData(34962, 1 << e, 35048),
...
var Vd = (a, b) => {
  ...
  Me = (a, b) => {
    var c = Je(Wd),
      d = { handle: c, attributes: b, version: b.Kj, Ui: a };
  ...
  Ne = (a) => {
    ...
    if (!a.pl) {
      ...
      re(b);
      2 <= a.version &&
        (b.Wi = b.getExtension("EXT_disjoint_timer_query_webgl2"));
      if (2 > a.version || !b.Wi)
        b.Wi = b.getExtension("EXT_disjoint_timer_query");
...
function af(a, b, c) {
  function d(g, h) {
    ...
    for (var n in g) if (g[n] != h[n]) return !1;
    return !0;
  }
  for (var e in $e) {
    var f = $e[e];
...
function ff(a) {
  ...
  if (a.Si)
    (a.hl = b),
      a.target.addEventListener(a.Oi, b, a.Ri),
      Ye.push(a),
      gf || (nb.push(Xe), (gf = !0));
  else
    for (var c = 0; c < Ye.length; ++c)
      Ye[c].target == a.target && Ye[c].Oi == a.Oi && Ze(c--);
  return 0;
}
function hf(a) {
  return a
...
var kf = {},
  ...
  If = (a) =>
    0 > yf.indexOf(a) ? a.getBoundingClientRect() : { left: 0, top: 0 },
  Jf = (a, b) => {
    if (0 != b.qk || 0 != b.Yj) {
      Gf(a);
      var c = b.Cl ? innerWidth : screen.width,
      ...
      g = g[1];
      3 == b.qk
        ? (Hf(a, (d - e) / 2, (c - f) / 2), (c = f), (d = e))
        : 2 == b.qk &&
          (c * g < h * d
            ? ((f = (g * c) / h), Hf(a, (d - f) / 2, 0), (d = f))
            : ((f = (h * d) / g), Hf(a, 0, (c - f) / 2), (c = f)));
      ...
      a.style.height = d + "px";
      1 == b.jl &&
        ((a.style.hj = "optimizeSpeed"),
        (a.style.hj = "-moz-crisp-edges"),
        (a.style.hj = "-o-crisp-edges"),
        (a.style.hj = "-webkit-optimize-contrast"),
        (a.style.hj = "optimize-contrast"),
        (a.style.hj = "crisp-edges"),
        (a.style.hj = "pixelated"));
      f = 2 == b.Yj ? devicePixelRatio : 1;
      0 != b.Yj &&
        ((c = (c * f) | 0),
        (d = (d * f) | 0),
        Ff(a, c, d),
        a.zj && a.zj.Ui.viewport(0, 0, c, d));
    }
...
var Wf = (a, b, c, d) => {
  2 <= R.version
    ? c && b
      ? S.bufferData(a, w, d, c, b)
      : S.bufferData(a, b, d)
    : S.bufferData(a, c ? w.subarray(c, c + b) : b, d);
};
function Xf(a) {
...
var qg = (a) => {
  ...
  vg = (a, b, c, d) => {
    if (!S.Cj) {
      ...
      g
        ? (f = g)
        : ((g = S.getParameter(34965)),
          (R.xj[f] = S.createBuffer()),
          S.bindBuffer(34963, R.xj[f]),
          S.bufferData(34963, 1 << f, 35048),
          S.bindBuffer(34963, g),
          (f = R.xj[f]));
...
var Ag = (a) => {
  ...
  Dg = (a, b, c, d, e) => {
    S.framebufferTexture2D(a, b, c, xe[d], e);
  };
function Eg(a) {
  S.frontFace(a);
}
...
var Lg = (a, b, c, d, e, f, g, h) => {
  ...
  Pg = (a, b, c) => {
    if (b) {
      ...
      if (void 0 === d)
        switch (((e = S.getParameter(a)), typeof e)) {
          case "number":
            d = e;
            break;
          case "boolean":
  ...
  Vg = (a, b, c) => {
    if (c)
      if (a >= se) W(1281);
      else if (((a = V[a]), 35716 == b))
        (a = S.getProgramInfoLog(a)),
          null === a && (a = "(unknown error)"),
          (E[c >> 2] = a.length + 1);
      else if (35719 == b) {
        if (!a.Nj)
          for (b = 0; b < S.getProgramParameter(a, 35718); ++b)
            a.Nj = Math.max(a.Nj, S.getActiveUniform(a, b).name.length + 1);
        E[c >> 2] = a.Nj;
      } else if (35722 == b) {
        if (!a.Lj)
          for (b = 0; b < S.getProgramParameter(a, 35721); ++b)
            a.Lj = Math.max(a.Lj, S.getActiveAttrib(a, b).name.length + 1);
        E[c >> 2] = a.Lj;
      } else if (35381 == b) {
        if (!a.Mj)
          for (b = 0; b < S.getProgramParameter(a, 35382); ++b)
            a.Mj = Math.max(a.Mj, S.getActiveUniformBlockName(a, b).length + 1);
        E[c >> 2] = a.Mj;
  ...
  Wg = (a, b, c) => {
    if (c) {
      ...
      b =
        2 > R.version
          ? S.Wi.getQueryObjectEXT(a, b)
          : S.getQueryParameter(a, b);
      var d;
  ...
  Zg = (a, b, c) => {
    c
      ? 35716 == b
        ...
        : 35720 == b
        ? ((a = S.getShaderSource(ye[a])), (E[c >> 2] = a ? a.length + 1 : 0))
        : (E[c >> 2] = S.getShaderParameter(ye[a], b))
      : W(1281);
  },
  $g = (a) => {
    var b = Fe[a];
  ...
  bh = (a) => {
    ...
    if (!b)
      for (
        a.Gj = b = {}, a.Sk = {}, d = 0;
        d < S.getProgramParameter(a, 35718);
        ++d
      ) {
  ...
  ch = (a, b) => {
    ...
    if ((a = V[a])) {
      ...
      if (
        (e = a.Tk[e]) &&
        d < e[0] &&
        ((d += e[1]), (c[d] = c[d] || S.getUniformLocation(a, b)))
      )
        return d;
    } else W(1281);
    return -1;
  ...
  X = (a) => {
    ...
    if (b) {
      ...
      "number" == typeof c &&
        (b.Gj[a] = c =
          S.getUniformLocation(b, b.Sk[a] + (0 < c ? "[" + c + "]" : "")));
      return c;
    }
    W(1282);
  },
  ...
  gh = (a) => ((a = ze[a]) ? S.isVertexArray(a) : 0),
  hh = (a) => {
    a = V[a];
    S.linkProgram(a);
    a.Gj = 0;
  ...
  lh = (a, b, c, d, e, f, g) => {
    if (2 <= R.version)
      if (S.$j) S.readPixels(a, b, c, d, e, f, g);
      else {
        var h = jh(f);
        S.readPixels(
          a,
  ...
  if (2 <= R.version)
    if (S.Yi) S.texImage2D(a, b, c, d, e, f, g, h, n);
      ...
      S.texImage2D(
        ...
        h,
        p,
        n >> (31 - Math.clz32(p.BYTES_PER_ELEMENT))
      );
...
var uh = (a, b, c, d, e, f, g, h, n) => {
    if (2 <= R.version)
      ...
      (p = null),
        n && (p = kh(h, g, e, f, n)),
        S.texSubImage2D(a, b, c, d, e, f, g, h, p);
  },
  vh = (a, b) => {
    S.uniform1f(X(a), b);
  },
  ...
  Bh = (a, b, c) => {
    if (2 <= R.version) b && S.uniform2fv(X(a), H, c >> 2, 2 * b);
      ...
      if (144 >= b)
        for (var d = wh[2 * b - 1], e = 0; e < 2 * b; e += 2)
          (d[e] = H[(c + 4 * e) >> 2]), (d[e + 1] = H[(c + (4 * e + 4)) >> 2]);
  ...
  Ch = (a, b, c) => {
    if (2 <= R.version) b && S.uniform2iv(X(a), E, c >> 2, 2 * b);
      ...
      if (144 >= b)
        for (var d = zh[2 * b - 1], e = 0; e < 2 * b; e += 2)
  ...
  Dh = (a, b, c) => {
    if (2 <= R.version) b && S.uniform3fv(X(a), H, c >> 2, 3 * b);
      ...
      if (96 >= b)
        for (var d = wh[3 * b - 1], e = 0; e < 3 * b; e += 3)
          (d[e] = H[(c + 4 * e) >> 2]),
            (d[e + 1] = H[(c + (4 * e + 4)) >> 2]),
            (d[e + 2] = H[(c + (4 * e + 8)) >> 2]);
  ...
  Eh = (a, b, c) => {
    if (2 <= R.version) b && S.uniform3iv(X(a), E, c >> 2, 3 * b);
      ...
      if (96 >= b)
        for (var d = zh[3 * b - 1], e = 0; e < 3 * b; e += 3)
          (d[e] = E[(c + 4 * e) >> 2]),
            (d[e + 1] = E[(c + (4 * e + 4)) >> 2]),
            (d[e + 2] = E[(c + (4 * e + 8)) >> 2]);
  ...
  Gh = (a, b, c) => {
    if (2 <= R.version) b && S.uniform4iv(X(a), E, c >> 2, 4 * b);
      ...
      if (72 >= b)
        for (var d = zh[4 * b - 1], e = 0; e < 4 * b; e += 4)
          (d[e] = E[(c + 4 * e) >> 2]),
            (d[e + 1] = E[(c + (4 * e + 4)) >> 2]),
            (d[e + 2] = E[(c + (4 * e + 8)) >> 2]),
            (d[e + 3] = E[(c + (4 * e + 12)) >> 2]);
  ...
  Hh = (a, b, c, d) => {
    if (2 <= R.version) b && S.uniformMatrix2fv(X(a), !!c, H, d >> 2, 4 * b);
      ...
      if (72 >= b)
        for (var e = wh[4 * b - 1], f = 0; f < 4 * b; f += 4)
          (e[f] = H[(d + 4 * f) >> 2]),
            (e[f + 1] = H[(d + (4 * f + 4)) >> 2]),
            (e[f + 2] = H[(d + (4 * f + 8)) >> 2]),
            (e[f + 3] = H[(d + (4 * f + 12)) >> 2]);
  ...
  Ih = (a, b, c, d) => {
    if (2 <= R.version) b && S.uniformMatrix3fv(X(a), !!c, H, d >> 2, 9 * b);
      ...
      if (32 >= b)
        for (var e = wh[9 * b - 1], f = 0; f < 9 * b; f += 9)
          (e[f] = H[(d + 4 * f) >> 2]),
            (e[f + 1] = H[(d + (4 * f + 4)) >> 2]),
            (e[f + 2] = H[(d + (4 * f + 8)) >> 2]),
            (e[f + 3] = H[(d + (4 * f + 12)) >> 2]),
  ...
  Mh = (a, b, c, d, e, f) => {
    var g = R.fj[a];
    S.uj
      ? ((g.Bj = !1), S.vertexAttribPointer(a, b, c, !!d, e, f))
      : ((g.size = b),
        (g.type = c),
        (g.ik = d),
        (g.Sj = e),
...
var Oh = (a, b) => {
  ...
  Yh = (a, b, c, d, e, f) => {
    ...
    return ff({
      ...
      Si: d,
      Ti: (g) => {
        for (var h, n = {}, p = g.touches, q = 0; q < p.length; ++q)
          (h = p[q]), (h.Kk = h.Pk = 0), (n[h.identifier] = h);
        for (q = 0; q < g.changedTouches.length; ++q)
          (h = g.changedTouches[q]), (h.Kk = 1), (n[h.identifier] = h);
        for (q = 0; q < g.targetTouches.length; ++q)
          n[g.targetTouches[q].identifier].Pk = 1;
        p = uf;
        ib[p >> 3] = g.timeStamp;
        var u = p >> 2;
        E[u + 3] = g.ctrlKey;
        ...
        for (q in n)
          if (
            ...
            (E[u + 7] = h.Kk),
            (E[u + 8] = h.Pk),
            (E[u + 9] = h.clientX - v.left),
            (E[u + 10] = h.clientY - v.top),
            (u += 13),
            31 < ++r)
          )
            break;
...
function ei(a, b, c, d, e) {
  ...
  if (g) {
    ...
    A.onload = (U) => {
      ci.has(P) &&
        (f(),
        200 <= A.status && 300 > A.status ? b && b(a, A, U) : c && c(a, A, U));
    };
    A.onerror = (U) => {
    ...
    A.onreadystatechange = (U) => {
      ci.has(P) &&
        ((hb[(a + 40) >> 1] = A.readyState),
        2 <= A.readyState && (hb[(a + 42) >> 1] = A.status),
        e && e(a, A, U));
    };
    try {
      A.send(g);
...
var ti = (a) =>
  ...
  wi = (a, b, c, d) => {
    ...
    function g(r, B) {
      ...
      var G;
      0 === (G = y(r.getFullYear() - B.getFullYear())) &&
        0 === (G = y(r.getMonth() - B.getMonth())) &&
        (G = y(r.getDate() - B.getDate()));
      return G;
    }
    function h(r) {
      switch (r.getDay()) {
    ...
    p = {
      ...
      "%t": () => "\t",
      "%u": (r) => r.aj || 7,
      "%U": (r) => f(Math.floor((r.rj + 7 - r.aj) / 7), 2),
      "%V": (r) => {
      ...
      "%z": (r) => {
        ...
        return (
          (B ? "+" : "-") +
          String("0000" + ((r / 60) * 100 + (r % 60))).slice(-4)
        );
      },
      "%Z": (r) => r.Gl,
      "%%": () => "%",
  ...
  Fb = (a, b, c, d) => {
    ...
    return (c = (function (p) {
      0 !== g && Ue(g);
      return "string" === b ? (p ? x(w, p) : "") : "boolean" === b ? !!p : p;
    })(c));
  };
function Jc(a, b, c, d) {
  a || (a = this);
...
var Ei = {
    ...
    Kb: function (a, b, c) {
      try {
        ...
        a = 0;
        for (
          var e = $c(d, 0, 1), f = Math.floor(e / 280);
          f < d.pj.length && a + 280 <= c;
          ...
          if ("." === g) {
            ...
            (h = Fa(d.path, { parent: !0 }).node.id), (n = 4);
          else {
            var p = nc(d.node, g);
            h = p.id;
            n =
      ...
      try {
        return (
          ...
          0 === c
            ...
            : 512 === c
            ? La(b)
            : cb("Invalid flags passed to unlinkat"),
          0
        );
      } catch (d) {
        if ("undefined" == typeof jd || "ErrnoError" !== d.name) throw d;
    ...
    zb: function (a, b, c) {
      ...
      E[(c + 24) >> 2] = a.getDay();
      E[(c + 28) >> 2] =
        ((pd(a.getFullYear()) ? qd : rd)[a.getMonth()] + a.getDate() - 1) | 0;
    ...
    Ab: function (a) {
      ...
      E[(a + 24) >> 2] = b.getDay();
      E[(a + 28) >> 2] =
        ((pd(b.getFullYear()) ? qd : rd)[b.getMonth()] + b.getDate() - 1) | 0;
      E[a >> 2] = b.getSeconds();
    ...
    Bb: function (a) {
      ...
      E[(a + 28) >> 2] =
        ((b.getTime() - Date.UTC(b.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) /
          864e5) |
        0;
      a = b.getTime() / 1e3;
      return (
    ...
    nh: (a, b) => {
      ...
      R === Wd[a] && (R = null);
      if ("object" == typeof kf)
        for (var c = Wd[a].Ui.canvas, d = 0; d < Ye.length; ++d)
          Ye[d].target != c || Ze(d--);
    ...
    Ah: (a, b, c, d) => {
      ...
      switch (c) {
        ...
        case 12338:
          return (E[d >> 2] = ke.antialias ? 1 : 0), 1;
        case 12339:
          return (E[d >> 2] = 4), 1;
        case 12340:
          return (E[d >> 2] = 12344), 1;
    ...
    Mh: (a, b, c, d, e, f, g, h) => {
      ...
      q.onload = function () {
        if (
          ...
          (0 === q.status && "http" != p.substr(0, 4).toLowerCase())
        ) {
      ...
      q.onprogress = function (v) {
        h &&
          M(h)(
            ...
            d,
            v.loaded,
            v.lengthComputable || void 0 === v.lengthComputable ? v.total : 0
          );
      };
      q.onabort = function () {
        delete Qe[u];
    ...
    Hg: (a, b, c) => {
      S.bindAttribLocation(V[a], b, c ? x(w, c) : "");
    },
    Gg: Of,
    nd: (a, b, c) => {
    ...
    wg: (a, b, c, d) => {
      2 <= R.version
        ? c && S.bufferSubData(a, b, w, d, c)
        : S.bufferSubData(a, b, w.subarray(d, d + c));
    },
    vg: Xf,
    ug: Yf,
    Sc: function (a, b, c, d) {
    ...
    og: (a, b, c, d, e, f, g, h) => {
      2 <= R.version
        ? S.Yi || !g
          ? S.compressedTexImage2D(a, b, c, d, e, f, g, h)
          : S.compressedTexImage2D(a, b, c, d, e, f, w, h, g)
        : S.compressedTexImage2D(
            ...
            e,
            f,
            h ? w.subarray(h, h + g) : null
          );
    },
    Sd: (a, b, c, d, e, f, g, h, n) => {
      S.Yi
        ? S.compressedTexImage3D(a, b, c, d, e, f, g, h, n)
        : S.compressedTexImage3D(a, b, c, d, e, f, g, w, n, h);
    },
    ng: (a, b, c, d, e, f, g, h, n) => {
      2 <= R.version
        ? S.Yi || !h
          ? S.compressedTexSubImage2D(a, b, c, d, e, f, g, h, n)
          : S.compressedTexSubImage2D(a, b, c, d, e, f, g, w, n, h)
        : S.compressedTexSubImage2D(
            ...
            f,
            g,
            n ? w.subarray(n, n + h) : null
          );
    },
    Rd: (a, b, c, d, e, f, g, h, n, p, q) => {
      S.Yi
        ? S.compressedTexSubImage3D(a, b, c, d, e, f, g, h, n, p, q)
        : S.compressedTexSubImage3D(a, b, c, d, e, f, g, h, n, w, q, p);
    },
    Qc: function (a, b, c, d, e) {
      S.copyBufferSubData(a, b, c, d, e);
    },
    mg: function (a, b, c, d, e, f, g, h) {
      S.copyTexImage2D(a, b, c, d, e, f, g, h);
    },
    ...
    xc: (a, b) => {
      for (var c = 0; c < a; c++) {
        var d = E[(b + 4 * c) >> 2],
          e = Be[d];
        e && (S.deleteSampler(e), (e.name = 0), (Be[d] = null));
      }
    },
    dg: jg,
    Fc: (a) => {
        ...
        d
          ? d.zk & 16
            ? 0 > b || 0 > c || b + c > d.length
              ? (W(1281), l("invalid range in glFlushMappedBufferRange"))
              : S.bufferSubData(a, d.offset, w.subarray(d.cj + b, d.cj + b + c))
            : (W(1282),
              l(
                "buffer was not mapped with GL_MAP_FLUSH_EXPLICIT_BIT in glFlushMappedBufferRange"
              ))
          : (W(1282), l("buffer was never mapped in glFlushMappedBufferRange"));
    ...
    Lc: (a, b, c, d, e) => {
      a = V[a];
      if ((a = S.getActiveUniformBlockName(a, b)))
        e && 0 < c
          ? ((c = t(a, w, e, c)), d && (E[d >> 2] = c))
          : d && (E[d >> 2] = 0);
    },
    Mc: (a, b, c, d) => {
      if (d)
        if (((a = V[a]), 35393 == c))
          E[d >> 2] = S.getActiveUniformBlockName(a, b).length + 1;
        else {
    ...
    tf: (a, b, c, d) => {
      if ((a = S.getShaderSource(ye[a])))
        (b = 0 < b && d ? t(a, w, d, b) : 0), c && (E[c >> 2] = b);
    },
    wf: Zg,
    sf: $g,
    Rc: (a, b) => {
      if (2 > R.version) return W(1282), 0;
      var c = Ge[a];
      if (c) return 0 > b || b >= c.length ? (W(1281), 0) : c[b];
      switch (a) {
        case 7939:
          return (
            (c = S.getSupportedExtensions() || []),
            (c = c.concat(
              c.map(function (d) {
                return "GL_" + d;
              })
    ...
    Bc: (a, b, c, d, e) => {
      0 > c
        ? W(1281)
        : e
        ? ((a = S.getSyncParameter(De[a], b)),
          null !== a && ((E[e >> 2] = a), d && (E[d >> 2] = 1)))
        : W(1281);
    },
    rf: (a, b, c) => {
    ...
    ld: (a, b, c, d, e, f, g) => {
      a = V[a];
      if ((a = S.getTransformFeedbackVarying(a, b)))
        g && 0 < c
          ? ((c = t(a.name, w, g, c)), d && (E[d >> 2] = c))
          : d && (E[d >> 2] = 0),
          e && (E[e >> 2] = a.size),
          f && (E[f >> 2] = a.type);
    },
    ...
    kf: (a, b, c) => {
      c
        ? (R.fj[a].enabled &&
          ...
          (E[c >> 2] = S.getVertexAttribOffset(a, b)))
        : W(1281);
    },
    mf: (a, b, c) => {
      eh(a, b, c, 2);
    ...
    Vd: (a, b, c, d, e, f, g, h, n, p) => {
      if (S.Yi) S.texImage3D(a, b, c, d, e, f, g, h, n, p);
        ...
        S.texImage3D(
          ...
          n,
          q,
          p >> (31 - Math.clz32(q.BYTES_PER_ELEMENT))
        );
    ...
    Jd: (a) => {
      if (!Bg(a)) return W(1280), l("GL_INVALID_ENUM in glUnmapBuffer"), 0;
      var b = ue[Ag(a)];
      if (!b || !b.cj)
        return W(1282), l("buffer was never mapped in glUnmapBuffer"), 0;
      b.zk & 16 ||
        (2 <= R.version
          ? S.bufferSubData(a, b.offset, w, b.cj, b.length)
          : S.bufferSubData(a, b.offset, w.subarray(b.cj, b.cj + b.length)));
      ca(b.cj);
      b.cj = 0;
      return 1;
    },
    ...
    kd: (a, b, c, d, e) => {
      var f = R.fj[a];
      S.uj
        ? ((f.Bj = !1), S.vertexAttribIPointer(a, b, c, d, e))
        : ((f.size = b),
          (f.type = c),
          (f.ik = !1),
          (f.Sj = d),
    ...
    Xa: () =>
      (lf = navigator.getGamepads
        ...
        : -1,
    Oa: (a, b, c) =>
      "undefined" == typeof onbeforeunload ? -1 : 1 !== c ? -5 : Ph(a, b),
    ...
    Va: (a, b, c) =>
      navigator.getGamepads || navigator.webkitGetGamepads
        ? Sh(a, b, c, 26, "gamepadconnected")
        : -1,
    Ua: (a, b, c) =>
      navigator.getGamepads || navigator.webkitGetGamepads
        ? Sh(a, b, c, 27, "gamepaddisconnected")
        : -1,
    Dh: (a, b, c) =>
      setInterval(() => {
        Id(() => M(a)(c));
    ...
    eh: function (a, b, c, d, e) {
      ...
      u = !!(u & 32);
      if ("EM_IDB_STORE" === P)
        (K = F[(g + 84) >> 2]), fi(a, w.slice(K, K + F[(g + 88) >> 2]), r, y);
    ...
    Oh: (a, b) => {
      ...
      "WEBGL_multi_draw_instanced_base_vertex_base_instance" == b && re(S);
    ...
    wh: (a, b, c, d) => {
      function e(u, v, r, B, y, G) {
        ...
        if (10 === u)
          a: {
            ...
            for (A = 0; 8 > A; A++)
              0 === y[A] && (1 < A - U && (Q = 0), (U = A), Q++),
                Q > P && ((P = Q), (fa = A - P + 1));
            for (A = 0; 8 > A; A++)
              1 < P && 0 === y[A] && A >= fa && A < fa + P
                ? A === fa && ((N += ":"), 0 === fa && (N += ":"))
                : ((N += Number(Ci(y[A] & 65535)).toString(16)),
                  (N += 7 > A ? ":" : ""));
          }
        else N = ti(y);
        y = N;
      ...
      if (b && ((b = b ? x(w, b) : ""), (g = parseInt(b, 10)), isNaN(g)))
        return h & 1024 ? -2 : -8;
      if (!a)
        return (
          0 === n && (n = 2),
          0 === (h & 1) &&
            (2 === n ? (f = Di(2130706433)) : (f = [0, 0, 0, 1])),
          (a = e(n, p, q, null, f, g)),
          (F[d >> 2] = a),
          0
        );
  ...
  ba = (k._memcpy = (a, b, c) => (ba = k._memcpy = Z.Th)(a, b, c)),
  m = (a) => (m = Z.Vh)(a),
  ca = (a) => (ca = Z.Wh)(a),
  oi = (a) => (oi = Z.Xh)(a),
  Di = (a) => (Di = Z.Yh)(a),
...
k._create_game_callback = (a, b, c) =>
  (k._create_game_callback = Z.ci)(a, b, c);
k._player_info_callback = (a, b, c, d, e, f) =>
  (k._player_info_callback = Z.di)(a, b, c, d, e, f);
...
k._wallpaper_update_subscription_data = (a) =>
  (k._wallpaper_update_subscription_data = Z.ii)(a);
k._video_playback_started = () => (k._video_playback_started = Z.ji)();
k._video_playback_ended = () => (k._video_playback_ended = Z.ki)();
k._post_video_upload_callback = (a) =>
  (k._post_video_upload_callback = Z.li)(a);
...
k.dynCall_iiiiiij = (a, b, c, d, e, f, g, h) =>
  (k.dynCall_iiiiiij = Z.xi)(a, b, c, d, e, f, g, h);
...
k.dynCall_viijii = (a, b, c, d, e, f, g) =>
  (k.dynCall_viijii = Z.Bi)(a, b, c, d, e, f, g);
k.dynCall_iiiiij = (a, b, c, d, e, f, g) =>
  (k.dynCall_iiiiij = Z.Ci)(a, b, c, d, e, f, g);
k.dynCall_iiiiijj = (a, b, c, d, e, f, g, h, n) =>
  (k.dynCall_iiiiijj = Z.Di)(a, b, c, d, e, f, g, h, n);
k.dynCall_iiiiiijj = (a, b, c, d, e, f, g, h, n, p) =>
  (k.dynCall_iiiiiijj = Z.Ei)(a, b, c, d, e, f, g, h, n, p);
  ...
  function b() {
    if (!Hi && ((Hi = !0), (k.calledRun = !0), !eb)) {
      ...
      k.noFSInit ||
        ...
        (k.stdout = k.stdout),
        (k.stderr = k.stderr),
        k.stdin ? fd("/dev", "stdin", k.stdin) : Vc("/dev/tty", "/dev/stdin"),
        k.stdout
          ? fd("/dev", "stdout", null, k.stdout)
          : Vc("/dev/tty", "/dev/stdout"),
        k.stderr
          ? fd("/dev", "stderr", null, k.stderr)
          : Vc("/dev/tty1", "/dev/stderr"),
        Xc("/dev/stdin", 0),
        Xc("/dev/stdout", 1),
        Xc("/dev/stderr", 1));
      Bc = !1;
  ...
  if ("undefined" != typeof window && !window.Fi) {
    ...
    class c {
      ...
      async send(d, e) {
        ...
        for (var f = 10; !this.nj && f; )
          await new Promise((n) => setTimeout(n, 100)), f--;
        if (this.nj) {
          ...
          console.log(
            "DatagramWriter is not initialized. Couldn't send message."
          );
      }
      Al(d, e) {
...
"undefined" != typeof window &&
  ((api_error_callback = k.cwrap("api_error_callback", null, [
    "number",
    "string",
  ])),
  (create_game_callback = k.cwrap("create_game_callback", null, [
    "string",
    "string",
    "string",
  ])),
  (join_game_callback = k.cwrap("join_game_callback", null, ["string"])),
  (chat_callback = k.cwrap("chat_callback", null, ["string", "number"])),
  (player_info_callback = k.cwrap(
    "player_info_callback",
    null,
    "number string string string bool string".split(" ")
  )),
  (log_next_game_state = k.cwrap("log_next_game_state", null, [])),
  (start_game = k.cwrap("start_game", null, [])),
  (init_request_parameters = (a) => {
    var b = { method: "POST", credentials: "include", headers: {} };
  ...
  (gxc_request_room = (a, b, c, d, e, f) => {
    var g =
      ...
      location.host.startsWith("test.vectorwars.gmx.dev");
    g && (e = "debug");
        ...
        ? n.json().then((p) => {
            ...
            g
              ? ((q =
                  ...
                  "?game=debug&roomUrl=" +
                  u),
                set_local_share_url(q))
              : post_share_url(q);
            create_game_callback(p, q, u);
          })
        : n.json().then((p) => {
            if (window.parent) {
              var q = { type: "api_error" };
  ...
  (gxc_get_player_info = (a, b, c) => {
    ...
    var d = { method: "GET", credentials: "include", headers: {} };
      ...
      f.ok
        ? f.json().then((g) => {
            ...
            gxc_player_info.forEach((h) => {
              null !== h.playerId &&
                (null === h.user.userId
                  ? ((h.user.userId = ""), (h.user.guest = !0))
                  : (h.user.guest = !1),
                null === h.user.username && (h.user.username = "unknown"),
                null === h.user.avatarUrl && (h.user.avatarUrl = e));
            });
            window.parent &&
              ((g = { type: "players" }),
        ...
        : (404 == f.status &&
            [0, 1, 2, 3].forEach((g) =>
              player_info_callback(g, "unknown", e, "JOINED", !0, "")
            ),
  ...
  (gxc_receive_chat_message = (a, b, c) => {
    window.parent.postMessage(
      { type: "receive_chat_message", content: a, src: b, fl: c },
      "*"
    );
  }),
  (gxc_report_status = (a) => {
    window.parent.postMessage({ type: "report_status", status: a }, "*");
  }));
"undefined" != typeof window &&
  ((wallpaper_update_config = k.cwrap("wallpaper_update_config", null, [
    "string",
  ])),
  (wallpaper_reset_config = k.cwrap("wallpaper_reset_config", null, [
    "string",
  ])),
  (wallpaper_update_subscription_data = k.cwrap(
    "wallpaper_update_subscription_data",
    null,
    ["string"]
  )));
